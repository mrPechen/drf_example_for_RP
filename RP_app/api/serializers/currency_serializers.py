...
class MyQueryParams(serializers.Serializer):
    date_from = serializers.DateField(help_text='Начальная дата для фильтрации в формате ГГГГ-ММ-ДД')
    date_to = serializers.DateField(help_text='Конечная дата для фильтрации в формате ГГГГ-ММ-ДД')
    threshold = serializers.FloatField(help_text='Желаемая цена валюты в формате int или float')
