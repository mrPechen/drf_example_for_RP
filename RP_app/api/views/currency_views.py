...
from RP_app.api.serializers.currency_serializers import RatesSerializer, AnalyticsObjectSerializer, MyQueryParams
...
@swagger_auto_schema(method='GET', responce_body=RatesSerializer)
@api_view(['GET'])
...
@swagger_auto_schema(method='GET', query_serializer=MyQueryParams)
@api_view(['GET'])
